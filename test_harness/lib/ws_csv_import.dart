...
//
// A BATCH WITH ANY ERROR WRITES NOTHING. Partially importing 300 rows and
// stopping at row 47 leaves a mess nobody can unpick: the file cannot simply be
// re-run, because the first 46 are now duplicates-in-waiting. Validation is
// therefore whole-file, up front, and the applier refuses a plan that has
// errors in it.
// =============================================================================
